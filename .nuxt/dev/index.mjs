...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestHost, getRequestProtocol, removeResponseHeader, setHeader, getHeader, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Users/mp/Projects/website/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/mp/Projects/website/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/mp/Projects/website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, decodePath } from 'file:///Users/mp/Projects/website/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/mp/Projects/website/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/mp/Projects/website/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/mp/Projects/website/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/mp/Projects/website/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/mp/Projects/website/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mp/Projects/website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mp/Projects/website/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/mp/Projects/website/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/mp/Projects/website/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/mp/Projects/website/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/mp/Projects/website/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/mp/Projects/website/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mp/Projects/website/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/mp/Projects/website/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/mp/Projects/website/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/mp/Projects/website/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/mp/Projects/website/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/mp/Projects/website/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/mp/Projects/website/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/mp/Projects/website/node_modules/vue/index.mjs';
import devalue from 'file:///Users/mp/Projects/website/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file:///Users/mp/Projects/website/node_modules/pathe/dist/index.mjs';
import robots from 'file:///Users/mp/Projects/website/.nuxt/robots.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/mp/Projects/website/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/mp/Projects/website/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/mp/Projects/website/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/mp/Projects/website/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/mp/Projects/website/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mp/Projects/website","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mp/Projects/website/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mp/Projects/website/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mp/Projects/website/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mp/Projects/website/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/mp/Projects/website/public"
      ]
    },
    "http": {
      "domains": []
...
const _mqEViR3dig8zRbg3lVF2og4vn6eTEurmt9jrpf9Ei9U = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/mp/Projects/website";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"VerionLabs provides innovative software solutions for modern businesses, specializing in cloud architecture, AI & machine learning, and custom web applications."},{"name":"author","content":"VerionLabs"},{"property":"og:type","content":"website"},{"property":"og:title","content":"VerionLabs - Innovative Software Solutions"},{"property":"og:description","content":"Professional software solutions for startups to enterprise-level businesses."},{"property":"og:url","content":"https://verionlabs.com"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"VerionLabs - Innovative Software Solutions"},{"name":"twitter:description","content":"Professional software solutions for startups to enterprise-level businesses."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"VerionLabs - Innovative Software Solutions"};
...
const _1tpqstkdMsdw63GyInbpRuvJVg340OGTllzVzHvRzEI = (nitroApp) => {
...
const _h1Wq4Vw96P3qj6YT0h2Mutva96xZeSSqBAiQ4STwTV0 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _mqEViR3dig8zRbg3lVF2og4vn6eTEurmt9jrpf9Ei9U,
_1tpqstkdMsdw63GyInbpRuvJVg340OGTllzVzHvRzEI,
_h1Wq4Vw96P3qj6YT0h2Mutva96xZeSSqBAiQ4STwTV0
];
...
const _eUWKVQ = eventHandler((event) => {
...
const _jJfvow = defineEventHandler(async (e) => {
...
const _A7Qbry = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const __U8Vjz = defineEventHandler(async (e) => {
...
const _QL6e_y = defineEventHandler(async (e) => {
...
const _LTmPPJ = defineEventHandler(async (e) => {
...
const _6DOWkX = defineEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/mp/Projects/website/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/mp/Projects/website/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _DPweam = lazyEventHandler(() => {
...
const _lazy_rrf7jG = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _eUWKVQ, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_rrf7jG, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _jJfvow, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _A7Qbry, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: __U8Vjz, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _QL6e_y, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _LTmPPJ, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _6DOWkX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _DPweam, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rrf7jG, lazy: true, middleware: false, method: undefined }
];
